  ...
  void initState() {
    ...
    FirebaseDatabase.instance
      ...
      setState(() {
        ...
        _selectedNumber =
            int.parse(event.snapshot.child('hours').value.toString());
        _notesController = TextEditingController(
            text: event.snapshot.child('notes').value.toString());
      });
    });
  }
            ...
            Expanded(
              ...
              child: Container(
                ...
                child: Container(
                  ...
                  child: Text(_selectedNumber.toString(),
                      style: TextStyle(fontSize: 16)),
                ),
              ),
            ),
                ...
                child: Container(
                  ...
                  child: ElevatedButton(
                    style: ElevatedButton.styleFrom(
                        ...
                        fixedSize: Size(40, 35)),
                    child:
                        Text("select number", style: TextStyle(fontSize: 15)),
                    onPressed: () {
                      showDialog(
                        context: context,
                        builder: (BuildContext context) {
                ...
                child: Container(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      labelStyle:
                          TextStyle(fontSize: 18, color: Color(0xFF7C7C7C)),
                    ),
                  ),
                ),
              ),
